...
date: '2022-01-21'
tags: [wechaty, bot, sso, authing]
description: 分别以微信群、飞书、Authing 作为上游用户源，构建人事管理机器人的实际案例教程。
image: /images/authing-wechaty/flow.webp
---

# 用户故事

其实用 [Authing](https://www.authing.cn/?utm_source=v0&utm_campaign=blog) 团队管理 + Wechaty 机器人能够实现很多功能，来提高传统人事管理的效率。甚至还可以做一些数据的分析、统计，来辅助决策。这里我就列了几个简单的现实场景，希望能帮助大家理解。
...
示例中（来自 POC 项目）使用的 Wechaty 版本为 `0.75` 和 puppty 为 `padlocal` （基于 iPad 微信协议）。可以访问示例代码仓库下载： [https://github.com/Authing/wechaty-authing-poc](https://github.com/Authing/wechaty-authing-poc)
...
graph TD
  Start1(Start)
  --> add1[管理员人为添加群成员]
  --管理 Bot 侦听入群事件--> add2[Bot 向 Authing 注册用户]
  --用户提及 Bot 发送手机号 --> add3[Bot 向 Authing 更新绑定用户手机号]
  --> End1(End)

  Start2(Start)
  --> del1[管理员人为删除群成员]
  --管理 Bot 侦听退群事件-->  del2[Bot 向 Authing 删除用户]
  --> End2(End)
```
...
graph TD
  Start1(Start)
  --Bot 启动--> step11[侦听好友申请和文本消息]
  -->|好友请求事件或文本消息| step12[根据手机号接受请求并邀请入群]
  --> End1(End)
```
...
参考文档： [https://docs.authing.cn/v2/reference/sdk-for-node/management/](https://docs.authing.cn/v2/reference/sdk-for-node/management/)
...
更多关于 Wechaty 插件的使用及开发，可以访问： [https://wechaty.js.org/docs/using-plugin-with-wechaty/overview](https://wechaty.js.org/docs/using-plugin-with-wechaty/overview)

## 注意事项

## 微信限制

- 微信好友上限： 5000 人 [https://kf.qq.com/faq/161223IrAjUn161223riUzaa.html](https://kf.qq.com/faq/161223IrAjUn161223riUzaa.html)
- 主动添加好友： 每日 30 次请求上限
- 被动添加好友： 每日 180 次请求上限
- 邀请加群： [https://kf.qq.com/faq/161223uIfIre161223aUrmqU.html](https://kf.qq.com/faq/161223uIfIre161223aUrmqU.html)
  - 超过 40 人群需要对方同意
...
- Wechaty Authing 插件仓库： [https://github.com/Authing/wechaty-authing](https://github.com/Authing/wechaty-authing)
- 基于该插件的 POC 示例代码仓库： [https://github.com/Authing/wechaty-authing-poc](https://github.com/Authing/wechaty-authing-poc)
