...
export function LoadingToast() {
  ...
  return (
    <div
      className={clsx(
        'fixed bottom-5 right-5 flex items-center w-full max-w-xs p-4 space-x-4 space-x shadow-lg bg-neutral text-neutral-content rounded-box',
        {
      ...
      <div className='ml-3 text-sm font-normal'>
        Loading... {'    '}
        <a href={pendingPath} className='text-secondary'>
          手动刷新
        </a>
      </div>
    </div>
